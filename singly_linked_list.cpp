...
int main(){     
    ...
    do{
        cout<<"\n";
    cout<<"WELCOME_TO_SLLIST_DATASTRUCTURE__"<<endl;
    ...
    switch(option){
        ...
        case 2:
     {
        ...
        cin>>key;
        if(s.nodeexistwithkey(key)!=NULL){
        ...
        case 5:
    {
        ...
        s.insertafterkeynode(key1,newnode3);
        break;
    }
        case 6:
        {
